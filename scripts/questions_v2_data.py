...
_QUESTIONS: list[tuple[str, str, int, float]] = [
    ...
    ("Are they from Asia?", "Nationality", 1, 0.38),
    ("Are they from Europe?", "Nationality", 1, 0.38),
    ...
    ("Did they win a Nobel science prize?", "Awards", 4, 0.30),
    ("Did they win a big music prize?", "Awards", 4, 0.30),
    ("Did they win a big movie prize?", "Awards", 4, 0.30),
    ("Are they a ninja or samurai?", "Anime", 4, 0.32),
    ("Are they a space traveler?", "Movies", 4, 0.30),
    ("Are they a pirate?", "Movies", 4, 0.26),
    ("Are they a detective?", "TV", 4, 0.28),
    ("Are they a doctor in the story?", "TV", 4, 0.26),
    ("Are they a teacher in the story?", "Anime", 4, 0.24),
    ("Are they a student in the story?", "Anime", 4, 0.28),
    ("Are they a robot or cyborg?", "Gaming", 4, 0.28),
    ("Are they a wizard?", "Fictional traits", 4, 0.30),
    ("Are they a princess?", "Fictional traits", 4, 0.28),
    ("Are they a knight?", "Fictional traits", 4, 0.26),
